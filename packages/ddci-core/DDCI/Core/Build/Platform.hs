...
determineHostArch
 = do   (exitCode, strArch, _) 
        ...
        let result
                ...
                | isPrefixOf "i386"   strArch   = Just ArchX86
                | isPrefixOf "i486"   strArch   = Just ArchX86
                | isPrefixOf "i586"   strArch   = Just ArchX86
                | isPrefixOf "i686"   strArch   = Just ArchX86
                | isPrefixOf "x86_64" strArch   = Just ArchX86_64
                | isPrefixOf "ppc"    strArch   = Just ArchPPC
