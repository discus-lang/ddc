...
convertBoundNameM nn
 = case nn of
        ...
        L.NameBool val       -> return $ O.NameLitBool val
        L.NameNat  val       -> return $ O.NameLitNat  val
        L.NameInt  val       -> return $ O.NameLitInt  val
        L.NameWord val bits  -> return $ O.NameLitWord val bits
