...
ddc-alpha_src_alex_x	        =  $(shell find packages/ddc-alpha -name "*.x" -follow)
ddc-alpha_src_alex_hs	        =  $(patsubst %.x,%.hs,$(src_alex_x))

# -- files that are ready to compile
ddc-alpha_src_hs_existing	=  $(shell find packages/ddc-alpha -name "*.hs" -follow)

# -- files that will be generated
ddc-alpha_src_hs_generated = \
        packages/ddc-alpha/Config/Config.hs \
...
packages/ddc-alpha/Config/Config.hs : packages/ddc-alpha/Config/Config.hs.$(Target)
...
make/deps/Makefile-ddc-alpha.deps : $(ddc-alpha_src_hs_existing) $(ddc-alpha_src_hs_generated)
	...
	@$(GHC) -ipackages/ddc-alpha -M $^ -dep-makefile \
