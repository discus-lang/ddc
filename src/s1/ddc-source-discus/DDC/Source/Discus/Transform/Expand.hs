...
-- @
--
module DDC.Source.Discus.Transform.Expand
        ( expandModule
        , Expand        (..))
where
 ...
 = let
        ...
        makeBind u
         = case u of
                ...
                UHole   -> error "ddc-source-discus.expandQuant: not expanding hole in type"
                UIx{}   -> error "ddc-source-discus.expandQuant: not expanding deBruijn type var"
